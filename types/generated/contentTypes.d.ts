...
export interface ApiLicenseSeatLicenseSeat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One JavaRock username/password seat linked to one Android device.';
    displayName: 'License Seat';
    pluralName: 'license-seats';
    singularName: 'license-seat';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    lastAppVersion: Schema.Attribute.String;
    lastSeenAt: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::license-seat.license-seat'
    > &
      Schema.Attribute.Private;
